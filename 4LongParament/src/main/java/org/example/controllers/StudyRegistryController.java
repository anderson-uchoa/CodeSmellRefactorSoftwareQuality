...
public class StudyRegistryController {
    ...
    private void handleSetObjective(StudyObjective objective){
        ...
        objective.handleSetObjective(new ObjectiveData(Integer.parseInt(getInput()), Integer.parseInt(getInput()),Integer.parseInt(getInput()),Integer.parseInt(getInput()),Integer.parseInt(getInput()),
    ...
    private void handleSetSteps(StudyPlan studyPlan){
        ...
        studyPlan.assignSteps(new StepAssignment(getInput(), getInput(), getInput(), getInput(), getInput(), getInput(), getInput(), getInput(), getInput(),
    ...
    private void editAudio(AudioReference audioReference){
        ...
        audioReference.editAudio(new AudioMetadata(quality, Boolean.parseBoolean(getInput()), getInput(), getInput(), getInput(), getInput(),
    ...
    private void getWeekInfo(){
        ...
        studyTaskManager.setUpWeek(new WeekSetup(getInput(), getInput(), getInput(), getInput(), getInput(), getInput(), getInput(), getInput(),
