...
public class StudyPlannerController {
    ...
    private void handleAddHabit(){
        ...
        habitTracker.addHabit(new HabitCreationData(name, motivation, dailyMinutesDedication, dailyHoursDedication, start.getYear(), start.getMonthValue(), start.getDayOfMonth(), start.getHour(), start.getMinute(), start.getSecond(), false));
    }
